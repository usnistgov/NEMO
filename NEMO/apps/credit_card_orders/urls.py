        ...
        include(
            [
                ...
                path(
                    ...
                    credit_card_orders.approve_credit_card_order,
                    name="approval_credit_card_order",
                ),
                path(
                    "<int:credit_card_order_id>/approve/",
                    credit_card_orders.approve_credit_card_order,
                    {"approved": True},
                    name="approve_credit_card_order",
                ),
                path(
                    "<int:credit_card_order_id>/deny/",
                    credit_card_orders.approve_credit_card_order,
                    {"approved": False},
                    name="deny_credit_card_order",
                ),
