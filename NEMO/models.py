...
class User(BaseModel):
	...
	is_accounting_officer = models.BooleanField('accounting officer', default=False, help_text='Designates this user as Accounting officer. Accounting officers can manager projects, view user details, and check usage/billing.')
