    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "action",
                    models.BooleanField(
                        choices=[(True, "Activated"), (False, "Deactivated")],
                        default=None,
                        help_text="The target state (activated or deactivated).",
                    ),
                ),
                (
                    "date",
                    models.DateTimeField(
                        default=django.utils.timezone.now, help_text="The time at which the active state was changed."
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        help_text="The alert can be deleted after the expiration time is reached.",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Allows the user to delete the alert. This is only valid when the 'user' field is set.",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "expiration_date",
                    models.DateTimeField(
                        blank=True, help_text="The comment will only be visible until this date.", null=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Reservations containing this configuration will be excluded from the NanoFab technician's Configuration Agenda page.",
                    ),
                ),
                (
                    "absence_string",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "configuration",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="NEMO.Configuration"),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        ...
                        help_text="The date and time when the user withdrew the consumable.",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "display_order",
                    models.IntegerField(
                        help_text="Contact information categories are sorted according to display order. The lowest value category is displayed first in the 'Contact information' page."
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "area",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="doors", to="NEMO.Area"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="The textual name that will be displayed underneath the image", max_length=40
                    ),
                ),
                (
                    "url",
                    models.CharField(
                        help_text="The URL that the choice leads to when clicked. Relative paths such as /calendar/ are used when linking within the NEMO site. Use fully qualified URL paths such as https://www.google.com/ to link to external sites.",
                        max_length=200,
                        verbose_name="URL",
                    ),
                ),
                ...
                (
                    "open_in_new_tab",
                    models.BooleanField(default=False, help_text="Open the URL in a new browser tab when it's clicked"),
                ),
                (
                    "secure_referral",
                    models.BooleanField(
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Hides this choice when the landing page is viewed from a mobile device",
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Hides this choice when the landing page is viewed from a desktop computer",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        default=django.utils.timezone.now,
                        help_text="The time at which the membership status was changed.",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "schedule",
                    models.IntegerField(choices=[(0, "Always"), (1, "Weekdays, 7am to midnight"), (2, "Weekends")]),
                ),
                ("area", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="NEMO.Area")),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=None,
                        help_text="Indicates that the reservation was made after the configuration deadline for a tool. NanoFab staff may not have enough time to properly configure the tool before the user is scheduled to use it.",
                    ),
                ),
                (
                    "cancelled",
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="When checked, indicates that the user will perform their own tool configuration (instead of requesting that the NanoFab staff configure it for them).",
                    ),
                ),
                (
                    "title",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "available",
                    models.BooleanField(
                        default=True, help_text="Indicates whether the resource is available to be used."
                    ),
                ),
                (
                    "restriction_message",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "safety_hazard",
                    models.BooleanField(
                        default=None, help_text="Indicates that this task represents a safety hazard to the NanoFab."
                    ),
                ),
                (
                    "creation_time",
                    models.DateTimeField(
                        default=django.utils.timezone.now, help_text="The date and time when the task was created."
                    ),
                ),
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        help_text="The timestamp of when a staff member initially responds to the task by changing its status.",
                        null=True,
                    ),
                ),
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, help_text="The estimated date and time that the task will be resolved.", null=True
                    ),
                ),
                (
                    "resolution_time",
                    models.DateTimeField(
                        blank=True,
                        help_text="The timestamp of when the task was marked complete or cancelled.",
                        null=True,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "visible",
                    models.BooleanField(default=True, help_text="Specifies whether this tool is visible to users."),
                ),
                (
                    "operational",
                    models.BooleanField(
                ...
                (
                    ...
                    models.OneToOneField(
                        blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to="NEMO.Interlock"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Indicates that after this training session the user was qualified to use the tool.",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "domain",
                    models.CharField(
                        blank=True, help_text="The Active Directory domain that the account resides on", max_length=100
                    ),
                ),
                (
                    "badge_number",
                    models.PositiveIntegerField(
                        blank=True,
                        help_text="The badge number associated with this user. This number must correctly correspond to a user in order for the tablet-login system (in the NanoFab lobby) to work properly.",
                        null=True,
                        unique=True,
                    ),
                ),
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Designates whether this user can log in to NEMO. Unselect this instead of deleting accounts.",
                        verbose_name="active",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.ManyToManyField(blank=True, related_name="users", to="NEMO.PhysicalAccessLevel"),
                ),
                (
                    "projects",
                    models.ManyToManyField(
                        blank=True,
                        help_text="Select the projects that this user is currently working on.",
                        to="NEMO.Project",
                    ),
                ),
                (
                    "qualifications",
                    models.ManyToManyField(
                        blank=True, help_text="Select the tools that the user is qualified to use.", to="NEMO.Tool"
                    ),
                ),
                (
                    "type",
                    models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to="NEMO.UserType"),
                ),
                (
                    "user_permissions",
                    models.ManyToManyField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True,
                help_text="The staff member who initially assessed the task after it was reported.",
                null=True,
                on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.AddField(
            ...
            name="tool",
            field=models.ForeignKey(
                help_text="The tool that this task relates to.",
                on_delete=django.db.models.deletion.CASCADE,
                to="NEMO.Tool",
            ),
        ),
        ...
        migrations.AddField(
            ...
            name="category",
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="NEMO.ResourceCategory"
            ),
        ),
        migrations.AddField(
            model_name="resource",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="child_content_type",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="parent_content_type",
                to="contenttypes.ContentType",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="category",
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="NEMO.ConsumableCategory"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="tool",
            field=models.ForeignKey(
                help_text="The tool that this comment relates to.",
                on_delete=django.db.models.deletion.CASCADE,
                to="NEMO.Tool",
            ),
        ),
