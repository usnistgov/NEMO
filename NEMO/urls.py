...
if settings.ALLOW_CONDITIONAL_URLS:
	urlpatterns += [
		...
		url(r'^email_tool_qualification_expiration/$', calendar.email_tool_qualification_expiration, name='email_tool_qualification_expiration'),
		...
		url(r'^users/search/$', users.user_search, name='user_search'),
