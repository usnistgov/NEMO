...
If you're interested in deploying NEMO at your organization, there are [deployment considerations](https://github.com/usnistgov/NEMO/wiki/Deployment-considerations) documented in the wiki. This covers what infrastructure you will need in order to have a robust production-level deployment. The [installation guides](https://github.com/usnistgov/NEMO/wiki/Installation-guides) provide a step-by-step guide to deploying NEMO. NIST is working on making NEMO easier to deploy (on Windows, Linux, Docker, and more).
