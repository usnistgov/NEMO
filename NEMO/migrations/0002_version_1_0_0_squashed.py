...
class Migration(migrations.Migration):
    ...
    replaces = [('NEMO', '0002_version_1_1_0'), ('NEMO', '0003_version_1_2_0'), ('NEMO', '0004_version_1_3_0'), ('NEMO', '0005_version_1_4_0'), ('NEMO', '0006_version_1_8_0'), ('NEMO', '0007_version_1_15_0'), ('NEMO', '0008_version_1_16_0'), ('NEMO', '0009_version_1_19_0'), ('NEMO', '0010_version_1_20_0'), ('NEMO', '0011_version_1_22_0')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(help_text='A brief description to quickly inform users about the outage', max_length=100)),
                ...
                ('category', models.CharField(blank=True, help_text='A categorical reason for why this outage is scheduled. Useful for trend analytics.', max_length=200)),
                ('resource', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='NEMO.Resource')),
            ],
        ),
        migrations.CreateModel(
            name='TaskHistory',
            fields=[
                ...
                ('task', models.ForeignKey(help_text='The task that this historical entry refers to', on_delete=django.db.models.deletion.CASCADE, related_name='history', to='NEMO.Task')),
                ('user', models.ForeignKey(help_text='The user that changed the task to this status', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
