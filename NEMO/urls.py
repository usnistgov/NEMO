...
urlpatterns = [
	...
	url(r'^billing_information/(?P<timeframe>(January|February|March|April|May|June|July|August|September|October|November|December), 20\d\d-(0[1-9]|1[012]))/$', usage.billing_information, name='billing_information'),
